    ...
    while(1)
    {
        ...
        case SELECT_FLOOR_S:
            ...
            else // update selection
            {
                ...
                {
                    destination_floor = destination_floor-1 % TOP_FLOOR; // decrement within floor loc's
                }
        ...
        case ACCELERATE_S:
        {
            INT8U debug = abs(travelling_dist) * ACCEL_TIME_PER_FLOOR_MS/ELEVATOR_TASK_PERIOD_MS; //TODO: update var name
